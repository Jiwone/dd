...
<body>
   ...
   <header id="header">
      <div class="content-container">
         <h1 id="logo">
            <a href="${path}/index">
            <img src="${path}/images/logo.png" alt="뉴렉처사이트" /></a>
         </h1>
         ...
         <section>
            ...
            <section id="search-form" >
               ...
               <form>
                  <label>과정검색</label>
                   <input type="text" /> 
                   <input class="btn-img btn btn-search" type="submit" value="검색" />
               </form>
            </section>
            ...
            <nav id="custom-menu" class="hr-list">
               ...
               <ul>
                  <li><a href="${path}/customer/notice-list">
                  <img src="${path}/images/txt-mypage.png"
                        alt="마이페이지"/></a></li>
